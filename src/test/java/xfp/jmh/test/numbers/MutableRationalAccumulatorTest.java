...
//----------------------------------------------------------------
/** Test desired properties of MutableRationalAccumulator,
 * as a kind of number.
 * <p>
 * <pre>
 * mvn -Dtest=xfp/java/test/numbers/MutableRationalAccumulator test > MutableRationalAccumulator.txt
 * </pre>
 *
...
public final class MutableRationalAccumulatorTest {
  ...
  public final void compareToTest () {
    final MutableRationalAccumulator f0 = 
      MutableRationalAccumulator.valueOf(-1.0);
    final MutableRationalAccumulator f1 = 
      MutableRationalAccumulator.valueOf(1.0);
  ...
  correctRounding (final MutableRationalAccumulator f) {
    ...
    final MutableRationalAccumulator fx = 
      MutableRationalAccumulator.valueOf(x);
    final int r = f.compareTo(fx);
    final boolean ok;
    if (r < 0) { // fx > f
      final double xlo = Math.nextDown(x);
      final MutableRationalAccumulator flo = 
        MutableRationalAccumulator.valueOf(xlo);
      ...
      final MutableRationalAccumulator fhi = 
        MutableRationalAccumulator.valueOf(xhi);
  ...
  private static final int TRYS = 1 * 1024 / 2;

  @SuppressWarnings({ "static-method" })
  @Test
  public final void rounding1311Test () {
    final MutableRationalAccumulator f = 
      MutableRationalAccumulator.valueOf(13,11);
  ...
  public final void fromBigIntegersRoundingTest () {
    ...
    for (int i=0;i<TRYS;i++) {
      ...
      final MutableRationalAccumulator f = 
        MutableRationalAccumulator.valueOf(n,d);
      assertTrue(correctRounding(f)); } }
