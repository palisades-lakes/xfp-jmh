...
implements Ringlike<RationalFloatBI> {
  ...
  private static final RationalFloatBI
  reduced (final BigInteger n,
    ...
    if (gcd.compareTo(BigInteger.ONE) > 0) {
      ...
      //        + "\n"
      //        ;
      return new RationalFloatBI(n1,d1,e0); }

    return new RationalFloatBI(n0,d0,e0); }

  //--------------------------------------------------------------

  @Override
  public final RationalFloatBI negate () {
    if (isZero()) { return this; }
    return
      valueOf(numerator().negate(),denominator(),exponent()); }

  public final RationalFloatBI reciprocal () {
  ...
  private final RationalFloatBI add (final BigInteger n1,
                                     final BigInteger d1,
                                     final int e1) {
  ...
  @Override
  public final RationalFloatBI add (final RationalFloatBI q) {
    if (isZero()) { return q; }
    if (q.isZero()) { return this; }
    return add(q.numerator(),q.denominator(),q.exponent()); }

  public final RationalFloatBI add (final double z) {
  ...
  @Override
  public final RationalFloatBI subtract (final RationalFloatBI q) {
    if (isZero()) { return q.negate(); }
    if (q.isZero()) { return this; }
    return add(q.numerator().negate(),q.denominator(),q.exponent()); }

  @Override
  public final RationalFloatBI abs () {
    // TODO: direct signum
  ...
  private final RationalFloatBI multiply (final BigInteger n,
                                          final BigInteger d,
                                          final int e) {
    return
      valueOf(
  ...
  @Override
  public final RationalFloatBI multiply (final RationalFloatBI q) {
  ...
  public final RationalFloatBI add2 (final double z) {
    assert Double.isFinite(z);
  ...
  public final RationalFloatBI addProduct (final double z0,
                                           final double z1) {
...
//      numerator(),denominator().shiftLeft(-exponent())); }
  ...
  @Override
  public final int compareTo (final RationalFloatBI q) {
  ...
  public final boolean equals (final RationalFloatBI q) {
  ...
  public boolean equals (final Object o) {
    if (!(o instanceof RationalFloatBI)) { return false; }
    return equals((RationalFloatBI) o); }
  ...
  private RationalFloatBI (final BigInteger numerator,
  ...
  public static final RationalFloatBI valueOf (final BigInteger n,
                                               final BigInteger d,
                                               final int e) {
  ...
  public static final RationalFloatBI valueOf (final long n,
                                               final long d,
                                               final int e) {
  ...
  public static final RationalFloatBI valueOf (final int n,
                                               final int d,
                                               final int e) {
    if (d < 0) { return valueOf(-n,-d,e); }
    return
  ...
  private static final RationalFloatBI valueOf (final boolean nonNegative,
                                                final int e,
                                                final long t)  {
    if (0L == t) { return ZERO; }
  ...
  public static final RationalFloatBI valueOf (final double x)  {
    return valueOf(
  ...
  public static final RationalFloatBI valueOf (final float x)  {
    return valueOf(
  ...
  public static final RationalFloatBI valueOf (final byte x)  {
    return valueOf(BigInteger.valueOf(x)); }

  public static final RationalFloatBI valueOf (final short x)  {
    return valueOf(BigInteger.valueOf(x)); }

  public static final RationalFloatBI valueOf (final int x)  {
    return valueOf(BigInteger.valueOf(x)); }

  public static final RationalFloatBI valueOf (final long x)  {
    return valueOf(BigInteger.valueOf(x)); }
  ...
  public static final RationalFloatBI valueOf (final Integer x)  {
    return valueOf(x.intValue()); }

  public static final RationalFloatBI valueOf (final Long x)  {
    return valueOf(x.longValue()); }

  public static final RationalFloatBI valueOf (final BigDecimal x)  {
    throw Exceptions.unsupportedOperation(null,"valueOf",x); }
  //    return valueOf(x, BigInteger.ONE); }

  public static final RationalFloatBI valueOf (final BigInteger x)  {
    return valueOf(x, BigInteger.ONE,0); }

  public static final RationalFloatBI valueOf (final Number x)  {
    if (x instanceof RationalFloatBI) { return (RationalFloatBI) x; }
  ...
  public static final RationalFloatBI valueOf (final Object x)  {
    return valueOf((Number) x); }

  //--------------------------------------------------------------
  // Note: these need to be reduced.

  public static final RationalFloatBI ZERO =
    new RationalFloatBI(BigInteger.ZERO,BigInteger.ONE,0);

  public static final RationalFloatBI ONE =
    new RationalFloatBI(BigInteger.ONE,BigInteger.ONE,0);

  public static final RationalFloatBI TWO =
    new RationalFloatBI(BigInteger.ONE,BigInteger.ONE,1);

  public static final RationalFloatBI TEN =
    new RationalFloatBI(BigInteger.valueOf(5),BigInteger.ONE,1);

  public static final RationalFloatBI MINUS_ONE =
    ONE.negate();
