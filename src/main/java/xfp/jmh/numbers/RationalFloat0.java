...
implements Ringlike<RationalFloat0> {
  ...
  reduced (final boolean nonNegative,
    ...
    if (UnNatural0.ONE.equals(d)) {
      final int en = UnNatural0.loBit(n);
      final UnNatural0 n0 = (en != 0) ? n.shiftRight(en) : n;
      final int e0 = (e + en);
      return new RationalFloat0(nonNegative,n0,UnNatural0.ONE,e0); }

    final int en = UnNatural0.loBit(n);
    final int ed = UnNatural0.loBit(d);
    final UnNatural0 n0 = (en != 0) ? n.shiftRight(en) : n;
  ...
  public final float floatValue () {
    ...
    final int e0 = UnNatural0.hiBit(n00) - UnNatural0.hiBit(d00) - 1;
