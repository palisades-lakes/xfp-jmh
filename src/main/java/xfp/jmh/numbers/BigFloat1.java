...
public final class BigFloat1 
extends Number
implements Comparable<BigFloat1> {
  ...
  public final boolean isOne () { 
    return BigFloat1.ONE.equals(this); }

  //--------------------------------------------------------------

  public final BigFloat1 negate () {
    if (isZero()) { return this; }
    return valueOf(! nonNegative(),significand(),exponent()); }

  //--------------------------------------------------------------

  private final BigFloat1 add (final boolean n1,
                               final BigInteger t1,
                               final int e1) {
  ...
  public final BigFloat1 add (final BigFloat1 q) {
    if (isZero()) { return q; }
  ...
  private final BigFloat1 add (final boolean n1,
    ...
    if (de > 0) { 
      if (de < Doubles.EXPONENT_BITS) {
        t02 = t0; 
        t12 = BigInteger.valueOf(
          t1 << de); 
        e2 = e0; }
      else { 
        t02 = t0; 
        t12 = BigInteger.valueOf(t1)
          .shiftLeft(de); 
        e2 = e0; } }
    else if (de < 0) {
      t02 = t0.shiftLeft(-de); 
  ...
  public final BigFloat1 add (final double z) {
  ...
  public final BigFloat1 subtract (final BigFloat1 q) {
  ...
  public final BigFloat1 abs () {
    if (nonNegative()) { return this; }
    return negate(); }

  //--------------------------------------------------------------

  private final BigFloat1 multiply (final boolean nonNegative,
                                    final BigInteger t,
                                    final int e) {
    return valueOf(
  ...
  public final BigFloat1 multiply (final BigFloat1 q) {
  ...
  public final BigFloat1 multiply (final double z) {
    return 
      multiply(
        Doubles.nonNegative(z),
  ...
  public final BigFloat1 add2 (final double z) { 
    assert Double.isFinite(z);
    final BigFloat1 q = valueOf(z);
    return add(q.multiply(q)); }

  //--------------------------------------------------------------
  // TODO: optimize!

  public final BigFloat1 addProduct (final double z0,
                                     final double z1) { 
  ...
  @Override
  public final int compareTo (final BigFloat1 q) {
  ...
  public final boolean equals (final BigFloat1 q) {
  ...
  public boolean equals (final Object o) {
    if (!(o instanceof BigFloat1)) { return false; }
    return equals((BigFloat1) o); }
  ...
  private BigFloat1 (final boolean nonNegative,
                     final BigInteger t0,
                     final int e0) {
    //super();
    if (0 == t0.signum()) {
  ...
  public static final BigFloat1 valueOf (final boolean nonNegative,
                                         final BigInteger t,
                                         final int e) {
    if (0 == t.signum()) { return ZERO; }
    assert 0 < t.signum();
    return new BigFloat1(nonNegative,t,e); } 

  public static final BigFloat1 valueOf (final BigInteger n,
                                         final int e) {
    final int s = n.signum();
    if (0 == s) { return ZERO; }
    if (0 < s) { return new BigFloat1(true,n,e); } 
    return new BigFloat1(false,n.negate(),e); } 

  public static final BigFloat1 valueOf (final long t,
                                         final int e) {
    if (0L < t) {
      return valueOf(true,BigInteger.valueOf(t),e); }
    return valueOf(false,BigInteger.valueOf(-t),e); }

  public static final BigFloat1 valueOf (final int t,
                                         final int e) {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),e); }
    return valueOf(false,BigInteger.valueOf(-t),e); }
  ...
  private static final BigFloat1 valueOf (final boolean nonNegative,
                                          final int e0,
                                          final long t0)  {
    if (0L == t0) { return ZERO; }
    return valueOf(nonNegative,BigInteger.valueOf(t0),e0); } 

  public static final BigFloat1 valueOf (final double x)  {
    return valueOf(
  ...
  public static final BigFloat1 valueOf (final float x)  {
    return valueOf(
  ...
  public static final BigFloat1 valueOf (final byte t)  {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),0); }
    return valueOf(false,BigInteger.valueOf(-t),0); }

  public static final BigFloat1 valueOf (final short t)  {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),0); }
    return valueOf(false,BigInteger.valueOf(-t),0); }
  ...
  public static final BigFloat1 valueOf (final Byte x)  {
    return valueOf(x.byteValue()); }

  public static final BigFloat1 valueOf (final Short x)  {
    return valueOf(x.shortValue()); }

  public static final BigFloat1 valueOf (final Integer x)  {
    return valueOf(x.intValue()); }

  public static final BigFloat1 valueOf (final Long x)  {
    return valueOf(x.longValue()); }

  public static final BigFloat1 valueOf (final BigDecimal x)  {
    throw Exceptions.unsupportedOperation(null,"valueOf",x); }
  //    return valueOf(x, BigInteger.ONE); }

  public static final BigFloat1 valueOf (final BigInteger x)  {
    return valueOf(x,0); }

  public static final BigFloat1 valueOf (final Number x)  {
    if (x instanceof BigFloat1) { return (BigFloat1) x; }
  ...
  public static final BigFloat1 valueOf (final Object x)  {
    return valueOf((Number) x); }

  //--------------------------------------------------------------

  public static final BigFloat1 ZERO = 
    new BigFloat1(true,BigInteger.ZERO,0);

  public static final BigFloat1 ONE = 
    new BigFloat1(true,BigInteger.ONE,0);

  public static final BigFloat1 TWO = 
    new BigFloat1(true,BigInteger.ONE,1);

  public static final BigFloat1 TEN = 
    new BigFloat1(true,BigInteger.valueOf(5),1);

  public static final BigFloat1 MINUS_ONE =
    new BigFloat1(false,BigInteger.ONE,0);
