...
implements Comparable<BigFloat2> {
  ...
  private final BigFloat2 add (final boolean n1,
                               final BigInteger t1,
                               final int e1) {
  ...
  private static final BigFloat2 add (final boolean n1,
                                      final BigInteger t1,
                                      final boolean n0,
                                      final BigInteger t0,
                                      final int e) {
  ...
  public final BigFloat2 subtract (final BigFloat2 q) {
  ...
  public final BigFloat2 abs () {
    if (nonNegative()) { return this; }
    return negate(); }

  //--------------------------------------------------------------

  private final BigFloat2 multiply (final boolean nonNegative,
                                    final BigInteger t,
                                    final int e) {
    return valueOf(
  ...
  public final BigFloat2 multiply (final double z) {
    return 
      multiply(
        Doubles.nonNegative(z),
  ...
  private BigFloat2 (final boolean nonNegative,
                     final BigInteger t0,
                     final int e0) {
    //super();
    if (0 == t0.signum()) {
  ...
  public static final BigFloat2 valueOf (final boolean nonNegative,
                                         final BigInteger t,
                                         final int e) {
    if (0 == t.signum()) { return ZERO; }
    assert 0 < t.signum();
    return new BigFloat2(nonNegative,t,e); } 

  public static final BigFloat2 valueOf (final BigInteger n,
                                         final int e) {
    final int s = n.signum();
    if (0 == s) { return ZERO; }
    if (0 < s) { return new BigFloat2(true,n,e); } 
    return new BigFloat2(false,n.negate(),e); } 

  public static final BigFloat2 valueOf (final long t,
                                         final int e) {
    if (0L < t) {
      return valueOf(true,BigInteger.valueOf(t),e); }
    return valueOf(false,BigInteger.valueOf(-t),e); }

  public static final BigFloat2 valueOf (final int t,
                                         final int e) {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),e); }
    return valueOf(false,BigInteger.valueOf(-t),e); }
  ...
  public static final BigFloat2 valueOf (final byte t)  {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),0); }
    return valueOf(false,BigInteger.valueOf(-t),0); }

  public static final BigFloat2 valueOf (final short t)  {
    if (0 < t) {
      return valueOf(true,BigInteger.valueOf(t),0); }
    return valueOf(false,BigInteger.valueOf(-t),0); }
  ...
  public static final BigFloat2 ZERO = 
    new BigFloat2(true,BigInteger.ZERO,0);

  public static final BigFloat2 ONE = 
    new BigFloat2(true,BigInteger.ONE,0);

  public static final BigFloat2 TWO = 
    new BigFloat2(true,BigInteger.ONE,1);

  public static final BigFloat2 TEN = 
    new BigFloat2(true,BigInteger.valueOf(5),1);

  public static final BigFloat2 MINUS_ONE =
    new BigFloat2(false,BigInteger.ONE,0);
