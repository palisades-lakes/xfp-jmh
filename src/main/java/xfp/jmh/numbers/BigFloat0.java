...
extends Number
implements Comparable<BigFloat0> {
  ...
  public final boolean isOne () { 
    return BigFloat0.ONE.equals(this); }
  ...
  private final BigFloat0 add (final boolean n1,
                               final BigInteger t1,
                               final int e1) {
  ...
  public final BigFloat0 add (final double z) {
  ...
  public final BigFloat0 subtract (final BigFloat0 q) {
  ...
  public final BigFloat0 abs () {
    if (nonNegative()) { return this; }
    return negate(); }

  //--------------------------------------------------------------

  private final BigFloat0 multiply (final boolean nonNegative,
                                    final BigInteger t,
                                    final int e) {
    return valueOf(
  ...
  public final BigFloat0 multiply (final BigFloat0 q) {
  ...
  public final BigFloat0 multiply (final double z) {
    return 
      multiply(
        Doubles.nonNegative(z),
        BigInteger.valueOf(Doubles.significand(z)),
  ...
  public final BigFloat0 add2 (final double z) { 
    assert Double.isFinite(z);
    final BigFloat0 q = valueOf(z);
    return add(q.multiply(q)); }

  //--------------------------------------------------------------
  // TODO: optimize!

  public final BigFloat0 addProduct (final double z0,
                                     final double z1) { 
  ...
  public static final BigFloat0 valueOf (final BigInteger n,
                                         final int e) {
    final int s = n.signum();
    if (0 == s) { return ZERO; }
    if (0 < s) { return new BigFloat0(true,n,e); } 
    return new BigFloat0(false,n.negate(),e); } 
  ...
  public static final BigFloat0 valueOf (final BigInteger x)  {
    return valueOf(x,0); }
  ...
  public static final BigFloat0 ZERO = 
    new BigFloat0(true,BigInteger.ZERO,0);

  public static final BigFloat0 ONE = 
    new BigFloat0(true,BigInteger.ONE,0);

  public static final BigFloat0 TWO = 
    new BigFloat0(true,BigInteger.ONE,1);

  public static final BigFloat0 TEN = 
    new BigFloat0(true,BigInteger.valueOf(5),1);

  public static final BigFloat0 MINUS_ONE =
    new BigFloat0(false,BigInteger.ONE,0);
